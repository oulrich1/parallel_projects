C  comm_time.f  
C  Version 3:  Process 0 starts off the ring pass.
...
C 
C  See Chap 9, pp. 192 & ff and p. 205 in PPMPI.
C 
      PROGRAM Comm3
      INCLUDE 'ciof.h'
      INCLUDE 'mpif.h'
      ...
      integer         min_size   
      integer         size_incr  
      parameter (max_size = 1000, min_size = 1000,
...
C
 ...
 200      continue
C
          print *, 'io_process = ', io_process,
     +            ' time_array_order = ', time_array_order
C
