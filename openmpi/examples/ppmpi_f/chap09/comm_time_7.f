C  comm_time.f  
C  Version 7:  Process 0 starts off the ring pass.
...
C      Remove debug output.  Change number of tests.
...
C 
C  See Chap 9, pp. 192 & ff and p. 210 in PPMPI.
C 
      PROGRAM Comm7
      INCLUDE 'ciof.h'
      INCLUDE 'mpif.h'
